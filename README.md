...
2. Set how many work sessions you want, plus the work and rest length in minutes. You can type the numbers or use the steppers, and a small line shows how long your day will be and roughly when it ends.
3. Hit Start Day, or just press Enter.
4. Work until the timer hits zero. A sound plays, then click Continue to roll into the break.
5. Repeat until you are done. The finish screen shows a small recap: when you started and finished, how many sessions you completed, total time, the work and rest split with your average work block, overtime, and how long you sat paused.
...
The timer runs on real wall clock time, so if your Mac goes to sleep mid block, the elapsed time is still counted correctly when it wakes up. Pause and Resume freeze the clock whenever you need to step away. End Day stops early and still gives you the summary with everything you did so far. Reset Day on the summary screen wipes it all and takes you back to setup. Right click the menu bar icon to quit the app.
